...
UNUSUAL_DEV(  0x12d1, 0x1446, 0x0000, 0x0000,
		"HUAWEI MOBILE",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e1750_init,
		0),
...
UNUSUAL_DEV(  0x1bbb, 0xf000, 0x0000, 0x0000,
	"Alcatel MOBILE",
	"Mass Storage",
	US_SC_DEVICE, US_PR_DEVICE, usb_stor_others_init,
	0),

UNUSUAL_DEV(  0x12d1, 0x1C0B, 0x0000, 0x0000,
		"HUAWEI MOBILE",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e1750_init,
		0),
...
UNUSUAL_DEV(  0x12d1, 0x14D1, 0x0000, 0xf000,
		"HUAWEI MOBILE",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e173_init,
		0),
...
UNUSUAL_DEV(  0x12d1, 0x14FE, 0x0000, 0xf000,
		"HUAWEI MOBILE",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei4_init,
		0),				
UNUSUAL_DEV(  0x12d1, 0x1C0B, 0x0000, 0xf000,
		"HUAWEI MOBILE",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e173_init2,
		0),
...
UNUSUAL_DEV(  0x19d2, 0x1179, 0x0000, 0xf000,
		"ZTE MOBILE",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte2_init,
		0),
...
UNUSUAL_DEV(  0x2020, 0xF00E, 0x0000, 0x0000,
		"SPEEDUP MOBILE",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_speedup_init,
		0),
#endif
